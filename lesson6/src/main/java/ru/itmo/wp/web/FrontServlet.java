...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route, HttpServletRequest request, HttpServletResponse response)
        ...
        if (invokeMethod(request, response, before, page, view)) return;
        if (invokeMethod(request, response, method, page, view)) return;
        if (invokeMethod(request, response, after, page, view)) return;
...
//            throw new ServletException("Can't render template [pageClass=" + pageClass + ", method=" + method + "].", e);
    ...
    private boolean invokeMethod(HttpServletRequest request, HttpServletResponse response, Method method,
                                 Object page, Map<String, Object> view) throws ServletException, IOException {
        try {
    ...
    private Method getMethod(String methodName, Class<?> pageClass) {
        Method method = null;
